...
//			System.out.println("val" + value);
	...
	public static void main(String[] args) {
		...
		j_rand = new BetterRandomNumberGenerator(1);
		check_rand = new CheckRandomNumberGenerator();
		j_rand.setConstants(25943234432431234L, 11);
//		System.out.println("fdsfd "+ j_rand.nextInt(5));
//		System.out.println("fdsfd "+ j_rand.nextInt(5));
//		System.out.println("fdsfd "+ j_rand.nextInt(5));
//		System.out.println("fdsfd "+ j_rand.nextInt(5));
//		System.out.println("fdsfd "+ j_rand.nextInt(5));
//		System.out.println("fdsfd "+ j_rand.nextInt(5));
//		System.out.println("fdsfd "+ j_rand.nextInt(5));
		check_rand.check_random(j_rand, 1);
