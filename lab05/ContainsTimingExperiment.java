...
public class ContainsTimingExperiment {
  ...
  public static void main(String[] args) {
    ...
    try (FileWriter fw = new FileWriter(new File("contains.tsv"))) { // open up a file writer so we can write
                                                                                // to file.
      Random random = new Random();
      for (int exp = 10; exp <= 17; exp++) { // This is used as the exponent to calculate the size of the set.
